  ...
  return (
    <>
      ...
      <main className="min-h-screen relative z-10">
        ...
        {/* ヘッダーセクション */}
        <header className="mb-8 morphism-card rounded-3xl p-8 flex flex-col items-center">
          <Image
            src="/logo.png"
            alt="東工大奨学金検索サイトのロゴ"
            width={440} // 元画像の自然な横幅
          ...
          />
          <h1 className="sr-only">東工大奨学金検索サイト</h1>
        ...
        {/* フィルターセクション */}
        <section className="morphism-card rounded-3xl p-10 mb-10">
          <h2 className="text-xl font-bold text-slate-100 mb-8 text-center">奨学金検索フィルター</h2>
          ...
          {/* 範囲指定フィルター */}
          <div className="border-t border-slate-400/20 pt-8">
            <h3 className="text-lg font-semibold text-slate-100 mb-6 text-center">範囲指定</h3>
            ...
            <div>
              ...
              <div id="peopleRange-description" className="sr-only">
                推薦人数の範囲を0人から100人の間で設定できます。現在の設定は{peopleRange[0]}人から{peopleRange[1]}人です。
              </div>
              <Slider.Root
                id="peopleRange"
                ...
                aria-label="推薦人数の範囲"
                aria-describedby="peopleRange-description"
              >
            ...
            <div>
              ...
              <div id="amountRange-description" className="sr-only">
                年額の範囲を0万円から500万円の間で設定できます。現在の設定は{amoutRange[0]}万円から{amoutRange[1]}万円です。
              </div>
              <Slider.Root
                id="amountRange"
                className="relative flex items-center select-none touch-none w-full h-5"
                ...
                aria-label="年額の範囲"
                aria-describedby="amountRange-description"
              >
                <Slider.Track className="relative bg-slate-300 rounded-full flex-grow h-3 shadow-inner">
                  <Slider.Range className="absolute bg-gradient-to-r from-blue-500 to-cyan-400 rounded-full h-full shadow-sm" />
                </Slider.Track>
        ...
        <section>
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold text-slate-100">検索結果</h2>
            <span className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold rounded-full px-6 py-3 shadow-xl select-none ring-2 ring-blue-300">
              {filteredScholarData.length}/{scholarData.length}件
            </span>
          </div>
            ...
            >
              <div className="px-10 py-6">
                <Link
                  ...
                  className="text-2xl font-extrabold tracking-tight text-slate-100 hover:text-cyan-300 transition-all duration-300 no-underline"
                >
                  {scholarColumn["団体名"]}
                </Link>
              </div>
